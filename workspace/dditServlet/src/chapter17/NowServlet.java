...
//서블릿 클래스를 구현하려면 HttpServlet 클래스를 상속 받아야함
/*
 * <서블릿?>
 * JSP가 나오기 전의 표준. JAVA로 웹 어플리케이션 개발.
 * 서블릿 vs JSP => JSP가 더 간단함
 * 근데 why Servlet ? MVC 패턴에서 서블릿 기반 코드로 개발하는 경우가 있음 
 * <개발 과정?>
