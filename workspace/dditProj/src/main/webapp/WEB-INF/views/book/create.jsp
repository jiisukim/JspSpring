...
서버에서 응답 될 때 브라우저가 읽어서 해석할 수 있는 HTML로 최종 변환됨
 -->
<h2>${message}</h2>
<h1>책 생성하기</h1>
...
<!-- 
	* 파일 업로드 폼 방식 요청 처리
	- 파일 업로드 폼 안의 파일 요소(태그)값을 스프링 MVC가 지원하는 MultipartFile 매개변수로 처리함
 -->
...
name 속성을 가져야함. name속성은 키, value 속성은 값.
* 키 : 값 쌍을 HTTP 파라미터라고 부른다.
 -->
<a href="/gugu">구구단</a> <br/>
<a href="/point">성적계산</a><br/>
